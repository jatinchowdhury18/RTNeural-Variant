...
#define MyAppName "RTNeuralVariant"
...
LicenseFile=../../LICENSE
OutputBaseFilename="RTNeuralVariant-Win-{#MyAppVersion}"
OutputDir=.
...
[Files]
Source: "../../bin/Win64/RTNeuralVariant.vst3"; Excludes: "*.aaxplugin,*.clap"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/RTNeuralVariant.clap"; Excludes: "*.aaxplugin,*.vst3"; DestDir: "{code:GetDir|CLAP_64}"; Components: CLAP_64; Flags: ignoreversion recursesubdirs createallsubdirs
; Source: "../../bin/Win64/RTNeuralVariant.dll"; Excludes: "*.vst3,*.aaxplugin,*.clap"; DestDir: "{code:GetDir|VST_64}"; Components: VST_64; Flags: ignoreversion recursesubdirs createallsubdirs
; Source: "../../bin/Win64/RTNeuralVariant.exe"; Excludes: "*.vst3,*.aaxplugin,*.clap"; DestDir: "{code:GetDir|Standalone}"; Components: Standalone; Flags: ignoreversion recursesubdirs createallsubdirs
; Source: "../../bin/Win64/RTNeuralVariant.aaxplugin"; Excludes: "*.vst3,*.clap"; DestDir: "{code:GetDir|AAX}"; Components: AAX; Flags: ignoreversion recursesubdirs createallsubdirs
