...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    declare -a plugins=("build/RTNeuralVariant_artefacts/VST3/RTNeuralVariant.vst3")
else
    pluginval=$(install_pluginval_win)
    declare -a plugins=("build/RTNeuralVariant_artefacts/Release/VST3/RTNeuralVariant.vst3")
fi
